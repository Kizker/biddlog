              ...
              {users.map((user) => {
                ...
                return (
                  <tr key={user.id} style={{ borderBottom: '1px solid var(--line)' }}>
                    <td style={{ padding: '16px', fontWeight: 'bold', fontSize: '16px' }}>{user.username}</td>
                    ...
                    <td style={{ padding: '16px', textAlign: 'right', fontSize: '18px', fontWeight: 'bold', color: '#10b981' }}>
                      Rp {salary.total.toLocaleString('id-ID')}
                    </td>
                    <td style={{ padding: '16px', textAlign: 'center' }}>
                      <button className="secondary-button" style={{ fontSize: '12px' }}>Lihat Detail</button>
                    </td>
                  </tr>
                )
              })}
