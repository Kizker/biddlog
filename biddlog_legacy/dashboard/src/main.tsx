  ...
  const steps = [
    {
      ...
      content: (
        <>
          <p>
            Silakan unduh <strong>biddlog-portable-v1.0.zip</strong> dari server/web Anda.
            File ini sudah mencakup semua requirement yang dibutuhkan.
          </p>
          <a href="/downloads/biddlog-portable-v1.0.zip" className="guide-download-btn">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" />
            </svg>
            Unduh biddlog-portable-v1.0.zip
          </a>
        </>
      ),
    },
    {
      ...
      content: (
        <p>
          Ekstrak file <code>biddlog-portable-v1.0.zip</code> tersebut di laptop atau komputer Anda.
          Boleh ditaruh di mana saja (misalnya di Desktop atau Documents).
        </p>
      ),
    },
    {
      title: 'Menghubungkan HP',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      content: (
        <p>
          Sambungkan HP Anda ke komputer menggunakan kabel data (USB). Pastikan <strong>USB Debugging</strong> di HP Anda sudah aktif.
          Jika HP meminta izin (Allow USB Debugging), pilih <strong>Allow</strong>.
        </p>
      ),
    },
    {
      title: 'Menjalankan Scanner',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      content: (
        <>
          <p>Buka folder hasil ekstrak. Anda akan menemukan 2 file penting:</p>
          <div className="guide-file-list">
            <div className="guide-file-item">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" />
              </svg>
              <div>
                <strong>Mulai-Scan-Bidding.bat</strong>
                <span>Jalankan (klik 2x) untuk scan daftar barang reguler.</span>
              </div>
            </div>
            <div className="guide-file-item">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                <strong>Mulai-Scan-Invoice.bat</strong>
                <span>Jalankan (klik 2x) untuk scan invoice riwayat.</span>
              </div>
            </div>
          </div>
          <div className="guide-callout warning">
            ...
            <ul className="guide-callout-list">
              <li><strong>Windows Firewall</strong> mungkin meminta izin untuk Node.js. Pilih <strong>Allow Access</strong>.</li>
              <li>Jika HP menampilkan dialog <strong>"Allow USB debugging?"</strong>, centang <strong>"Always allow from this computer"</strong> lalu tekan <strong>Allow / OK</strong>.</li>
            </ul>
          </div>
        </>
      ),
    ...
    {
      title: 'Mengolah Hasil (Pilih File JSON)',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      content: (
        <>
          <p>
            Setelah jendela hitam menutup, buka folder <code>collector/output</code> dan masukkan file JSON ke web ini:
          </p>
          <div className="guide-file-list">
            <div className="guide-file-item highlight-blue">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" />
              </svg>
              <div>
                <strong>Tab Analyzer</strong>
                <span>Pilih File JSON, lalu pilih <code>bidding-items.json</code> dari subfolder <code>scan-list</code>.</span>
              </div>
            </div>
            <div className="guide-file-item highlight-green">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg>
              <div>
                <strong>Tab Hasil Bidding</strong>
                <span>Pilih Invoice JSON, lalu pilih <code>invoice-items.json</code> dari subfolder <code>invoice</code>.</span>
              </div>
            </div>
          </div>
        </>
  ...
  return (
    <section className="guide-container">
      <div className="guide-hero">
        ...
        <div>
          <h2 className="guide-hero-title">Panduan Instalasi dan Penggunaan</h2>
          <p className="guide-hero-subtitle">Portable Mode - Tanpa instalasi Node.js, Python, atau ADB secara terpisah</p>
        </div>
      </div>
...
function BerandaView() {
  const [pubData, setPubData] = React.useState<any>(null);
  const [pubLoading, setPubLoading] = React.useState(true);
  ...
  if (pubLoading) {
    return <div style={{ textAlign: 'center', padding: '40px 20px', color: '#94a3b8' }}>Memuat data...</div>;
  }

  if (!pubData || pubData.length === 0) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        <svg style={{ color: '#94a3b8', marginBottom: '12px' }} width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
        <h3 style={{ color: 'var(--navy)', marginBottom: '8px' }}>Belum Ada Pembagian</h3>
        <p style={{ color: '#94a3b8' }}>Silakan tunggu Admin mempublish daftar pembagian barang.</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #f1f5f9', paddingBottom: '12px', marginBottom: '16px' }}>
        <h3 style={{ margin: 0, color: 'var(--navy)' }}>Pembagian Barang Hari Ini</h3>
        {pubDate && <span style={{ fontSize: '11px', color: '#94a3b8' }}>Dipublish: {new Date(pubDate).toLocaleString('id-ID')}</span>}
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        {pubData.map((entry: any) => (
          <div key={entry.index} style={{ border: '1px solid #e2e8f0', borderRadius: '10px', padding: '14px 16px', background: '#fafbfc' }}>
            <div style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '8px', fontSize: '13px' }}>
              {entry.index}. {entry.username}
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              {entry.items.map((item: any, i: number) => (
                <div key={i} style={{ fontSize: '12px', color: '#475569', padding: '4px 8px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '4px' }}>
                  {item.name}
                  {item.accounts && <span style={{ color: '#6366f1', fontWeight: 600 }}> ({item.accounts.replace(/,/g, '/')})</span>}
                </div>
              ))}
            </div>
          </div>
...
function PresensiView({ loggedInUser, isDemoMode }: { loggedInUser: any, isDemoMode: boolean }) {
  ...
  const isOpen = isDemoMode || (timeStr >= '06:30' && timeStr <= '07:50');
  ...
  if (!isOpen) {
    return (
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        ...
        <p style={{ fontSize: '11px', marginTop: '16px', color: '#666' }}>Waktu Anda saat ini: {timeStr}</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--line)', paddingBottom: '12px', marginBottom: '16px' }}>
        <h3 style={{ margin: 0 }}>Form Presensi Harian</h3>
        {isDemoMode && <span style={{ padding: '4px 8px', background: '#fef3c7', color: '#d97706', borderRadius: '4px', fontSize: '12px', fontWeight: 600 }}>Mode Demo Aktif</span>}
      </div>
      <p style={{ marginBottom: '16px' }}>Waktu presensi: <strong>{timeStr}</strong></p>
      <button onClick={handleAttend} style={{ padding: '10px 24px', background: 'var(--blue)', color: '#fff', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer' }}>
        Klik untuk Hadir
      </button>

      {/* Live Table */}
      <div style={{ marginTop: '40px' }}>
        <h4 style={{ margin: '0 0 16px 0', borderBottom: '1px solid var(--line)', paddingBottom: '8px', color: 'var(--navy)' }}>Daftar Hadir Hari Ini (Live)</h4>
        {attendances.length === 0 ? (
          <p style={{ color: 'var(--muted)', fontSize: '13px' }}>Belum ada anggota yang absen hari ini.</p>
        ) : (
          <div style={{ border: '1px solid var(--line)', borderRadius: '8px', overflow: 'hidden' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', textAlign: 'left' }}>
              <thead style={{ background: '#f8fafc' }}>
                <tr>
                  <th style={{ padding: '10px 16px', borderBottom: '1px solid var(--line)', color: '#64748b', fontWeight: 600 }}>No</th>
                  <th style={{ padding: '10px 16px', borderBottom: '1px solid var(--line)', color: '#64748b', fontWeight: 600 }}>Nama Pengguna</th>
                  <th style={{ padding: '10px 16px', borderBottom: '1px solid var(--line)', color: '#64748b', fontWeight: 600 }}>Waktu Absen</th>
                  <th style={{ padding: '10px 16px', borderBottom: '1px solid var(--line)', color: '#64748b', fontWeight: 600 }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {attendances.map((a, i) => (
                  <tr key={i} style={{ borderBottom: '1px solid #f1f5f9' }}>
                    ...
                    <td style={{ padding: '10px 16px', fontWeight: 600, color: 'var(--navy)' }}>{a.username}</td>
                    <td style={{ padding: '10px 16px', color: '#64748b' }}>{a.created_at ? new Date(a.created_at).toLocaleTimeString('id-ID', {hour: '2-digit', minute:'2-digit'}) : '-'}</td>
                    <td style={{ padding: '10px 16px' }}>
                      <span style={{ padding: '4px 8px', background: '#dcfce7', color: '#166534', borderRadius: '4px', fontSize: '11px', fontWeight: 600, textTransform: 'capitalize' }}>{a.status}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
...
function ListDapatView({ loggedInUser, isDemoMode }: { loggedInUser: any, isDemoMode: boolean }) {
  const now = new Date();
  const hours = now.getHours();
  const minutes = now.getMinutes();
  const timeStr = `${hours.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}`;
  const isOpen = isDemoMode || timeStr >= '08:00';
  const hasInvoice = isDemoMode || false; // Mock status
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--line)', paddingBottom: '12px', marginBottom: '16px' }}>
        <h3 style={{ margin: 0 }}>Form Input Barang Dapat</h3>
...
function App() {
  ...
  const [loggedInUser, setLoggedInUser] = useState<{ id: number; username: string; role: 'admin' | 'anggota' } | null>(() => {
  ...
  useLayoutEffect(() => {
    localStorage.setItem('anggotaView', anggotaView);
  }, [anggotaView]);
  ...
  function fallbackCopyItemCodes(text: string) {
    ...
    try {
      ...
      if (successful) {
        ...
        alert('Berhasil disalin! (' + text.split('\\n').length + ' item)');
      } else {
        alert('Gagal menyalin kode item.');
      }
    } catch (err) {
  ...
  function copyItemCodes() {
    ...
    if (!navigator.clipboard) {
      fallbackCopyItemCodes(itemCodes);
      return;
    }
    ...
    navigator.clipboard
      ...
      .then(() => {
        setCopiedItemCodes(true);
        window.setTimeout(() => setCopiedItemCodes(false), 1400);
        alert('Berhasil disalin! (' + itemCodes.split('\n').length + ' item)');
      })
      .catch(() => {
        fallbackCopyItemCodes(itemCodes);
      });
  ...
  async function handleBagikan() {
    if (visibleItems.length === 0) {
      alert('Tidak ada barang untuk dibagikan');
      return;
    }

    const payload = {
      action: 'bulk_insert',
      items: visibleItems.map((entry) => ({
        raw_line: entry.raw_name,
        brand: entry.brand,
        model: entry.model,
        storage: entry.storage,
        grade: entry.grade_code,
        unit: entry.unit_no || 1,
        price: entry.auction_price_number,
        person: ''
      }))
    };

    try {
      const res = await fetch(getApiUrl('items.php'), {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload)
      });
      ...
      if (data.status === 'success') {
        alert(`Berhasil! ${data.message} (${visibleItems.length} item dikirim)`);
      } else {
        alert(`Gagal mengirim ke bagian pembagian: ${data.message}`);
      }
    } catch (err: any) {
    ...
    return (
      <div className="login-portal" style={{ display: 'flex', minHeight: '100vh', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)' }}>
        <form onSubmit={handleLogin} style={{ background: '#fff', padding: '32px', borderRadius: '12px', width: '360px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
          ...
          {loginError && (
            <div style={{ background: '#fee2e2', color: '#ef4444', padding: '10px', borderRadius: '6px', fontSize: '12px', marginBottom: '16px', textAlign: 'center', fontWeight: 500 }}>
              {loginError}
            </div>
          )}
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              {sidebarCollapsed ? (
                ...
                <><polyline points="11 17 6 12 11 7"/><line x1="18" y1="6" x2="18" y2="18"/></>
              )}
            </svg>
          </button>
          ...
          <nav className="sidebar-nav">
            {(() => {
              ...
              const viewMap: Record<string, AdminViewMode> = {
                ...
                'Gaji': 'gaji',
                'Limit Harga & Fee Barang': 'limit_harga',
                'Pengguna': 'pengguna',
              ...
              const iconMap: Record<string, React.ReactNode> = {
                ...
                'Analyzer': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>,
                'Hasil Bidding': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
                'Scanner': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>,
                'Pembagian Barang': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>,
                'Laporan Presensi': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>,
                'Laporan List Dapat': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>,
                'Gaji': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
                'Limit Harga & Fee Barang': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,
                'Pengguna': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
                'Audit Trail': <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,
              };
              return navGroups.map((group, gi) => (
                <React.Fragment key={gi}>
                  ...
                  {group.map(name => (
                    ...
                    >
                      <span className="sidebar-link-icon">{iconMap[name]}</span>
                      {!sidebarCollapsed && <span className="sidebar-link-text">{name}</span>}
                    </a>
                  ))}
                </React.Fragment>
              ));
              ...
              <section className="topbar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div className="summary" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <button 
                    ...
                    style={{ 
                      padding: '6px 12px', 
                      background: isDemoMode ? '#fee2e2' : '#fef3c7', 
                      color: isDemoMode ? '#ef4444' : '#d97706', 
                      border: `1px solid ${isDemoMode ? '#fca5a5' : '#fde68a'}`, 
                      borderRadius: '6px', 
                      fontWeight: 600, 
                      fontSize: '12px', 
                      cursor: 'pointer',
